...
const actions = {
  ...
  delView({ dispatch, state }: { dispatch: Dispatch; state: any }, view: any) {
  ...
  delVisitedView({ commit, state }: { commit: Commit; state: any }, view: any) {
    return new Promise(resolve => {
      commit("DEL_VISITED_VIEW", view);
      resolve([...state.visitedViews]);
    });
  },
  delCachedView({ commit, state }: { commit: Commit; state: any }, view: any) {
    return new Promise(resolve => {
  ...
  delOthersViews(
    { dispatch, state }: { dispatch: Dispatch; state: any },
    view: any
  ) {
    return new Promise(resolve => {
  ...
  delAllVisitedViews({ commit, state }: { commit: Commit; state: any }) {
    return new Promise(resolve => {
      commit("DEL_ALL_VISITED_VIEWS");
      resolve([...state.visitedViews]);
    });
  },
  delAllCachedViews({ commit, state }: { commit: Commit; state: any }) {
    return new Promise(resolve => {
